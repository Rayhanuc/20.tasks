    ...
    <body>
        <div class="container" id="main">
            ...
            <form action="tasks.php" method="POST">
                <table>
                    ...
                    <tbody>
                        ...
                        while($data = mysqli_fetch_assoc($result)){
                            ...
                            ?>
                            <tr>
                                <td><input class="label-inline" type="checkbox" name="taskids[]" value="<?php echo $data['id'] ; ?>"></td>
                ...
                <input class="button-primary" id="bulksubmit" type="submit" name="" value="Submit">
            </form>           
